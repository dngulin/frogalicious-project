...
// Generated at 2024-03-11T21:49:52.3560590+01:00
...
namespace Frog.Level.State {
    ...
    [StructLayout(LayoutKind.Explicit)]
    public unsafe struct SpringState {
        public const int SizeOf = 1;
        public const int AlignmentOf = 1;

        [FieldOffset(0)] private fixed byte _buffer[SizeOf];

        [FieldOffset(0)] public BoardDirection Direction;

        public void WriteDefault() {
            Direction = BoardDirection.Up;
        }

        public static bool operator ==(in SpringState l, in SpringState r) {
            fixed (byte* __l = l._buffer, __r = r._buffer) {
                return UnsafeUtility.MemCmp(__l, __r, SizeOf) == 0;
            }
        }
        public static bool operator !=(in SpringState l, in SpringState r) => !(l == r);

        public override bool Equals(object obj) => obj is SpringState casted && this == casted;
        public override int GetHashCode() => throw new NotSupportedException();
    }
