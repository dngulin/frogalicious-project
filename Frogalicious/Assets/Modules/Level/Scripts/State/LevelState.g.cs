...
// Generated at 2024-03-11T21:53:02.5783970+01:00
...
namespace Frog.Level.State {
    ...
    public unsafe struct ButtonState {
        ...
        [FieldOffset(1), MarshalAs(UnmanagedType.U1)] public bool IsPressed;
    ...
    public unsafe struct SpikesState {
        ...
        [FieldOffset(0)] public BoardColorGroup Color;
        [FieldOffset(1), MarshalAs(UnmanagedType.U1)] public bool IsActive;
    ...
    public unsafe struct CellState {
        ...
        [FieldOffset(4)] public TileState Tile;
    ...
    public unsafe struct CellsState {
        public const int SizeOf = 704;
        public const int AlignmentOf = 2;

        [FieldOffset(0)] private fixed byte _buffer[SizeOf];

        [FieldOffset(0)] public CellsArray Array;
        [FieldOffset(700)] public ushort Width;
        [FieldOffset(702)] public ushort Height;
    ...
    public unsafe struct LevelState {
        public const int SizeOf = 712;
        public const int AlignmentOf = 2;

        [FieldOffset(0)] private fixed byte _buffer[SizeOf];

        [FieldOffset(0)] public CellsState Cells;
        [FieldOffset(704)] public CharacterState Character;
